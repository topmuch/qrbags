...
// Demo Account
const demoAccount = { email: "agence@qrbag.com", password: "agence123" };

export default function AgencyLoginPage() {
  const router = useRouter();
  const { user, login, loading: authLoading, isAgency } = useAuth();
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 text-white p-8 md:p-12 flex-col justify-center">
        <div className="max-w-md mx-auto">
          <h2 className="text-3xl font-bold mb-6">
            QRBag pour les agences de voyage
          </h2>
          
          {/* Demo Illustration */}
          <div className="relative mb-8">
            <div className="w-full h-80 rounded-2xl bg-gradient-to-br from-amber-900 to-slate-900 flex items-center justify-center overflow-hidden">
              <div className="text-center p-6">
                <div className="inline-flex items-center gap-3 mb-4">
                  <div className="w-14 h-14 rounded-xl flex items-center justify-center bg-black">
                    <QrCode className="w-7 h-7 text-white" />
                  </div>
                  <span className="text-2xl font-bold">Scan en 30s</span>
                </div>
            ...
            {/* Badge */}
            <div className="absolute bottom-4 left-4 bg-black/40 backdrop-blur-sm px-4 py-2 rounded-lg text-sm flex items-center gap-2">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-3">
              ...
              <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Espace Agence</h1>
            </div>
            <p className="text-slate-600 dark:text-slate-400">Connectez-vous à votre dashboard sécurisé</p>
          </div>
          ...
          <div className="mt-8 p-4 bg-slate-100 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="text-xs font-medium text-[#ff7f00] hover:text-[#ff7f00]/80"
              >
                Remplir
              </button>
            </div>
            <div className="text-xs">
              <div className="flex justify-between items-center">
                <span className="text-slate-700 dark:text-slate-300 font-medium">Agence</span>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-600 dark:text-slate-400">
              ...
              <Link href="/admin/connexion" className="font-medium text-emerald-500 hover:text-emerald-600">
