...
export default function HajjAdminPage() {
  ...
  const getGlobalStatus = (baggages: Baggage[]): { status: string; label: string; color: string } => {
    ...
    if (statuses.some(s => s === 'scanned')) {
      return { status: 'scanned', label: '🔍 Scanné', color: 'bg-violet-100 text-violet-700' };
    }
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 bg-emerald-100 dark:bg-emerald-900/30 rounded-xl flex items-center justify-center">
                <Users className="w-6 h-6 text-violet-700 dark:text-violet-500" />
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white dark:bg-slate-800 border-slate-100 dark:border-slate-700 shadow-sm rounded-2xl">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 bg-emerald-100 dark:bg-emerald-900/30 rounded-xl flex items-center justify-center">
                <Luggage className="w-6 h-6 text-violet-700 dark:text-violet-500" />
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 bg-amber-100 dark:bg-violet-900/30 rounded-xl flex items-center justify-center">
                <Clock className="w-6 h-6 text-amber-600 dark:text-violet-500" />
              </div>
            </div>
          </CardContent>
        </Card>
                      ...
                      {baggage.founderName && (
                        <div className="mt-3 p-3 bg-emerald-50 border border-emerald-200 rounded-lg">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-violet-700 text-sm font-medium">👤 Trouvé par:</span>
                          ...
                          {baggage.founderPhone && (
                            <a 
                              ...
                              className="inline-flex items-center gap-1 text-violet-700 hover:text-emerald-700 text-sm"
                            >
