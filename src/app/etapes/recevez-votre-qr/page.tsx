          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <FadeIn>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 mb-6 tracking-[-0.02em] leading-[1.08]">
                Recevez
                <br />
                <span className="bg-gradient-to-r from-violet-500 to-violet-700 bg-clip-text text-transparent">votre QR code</span>
              </h1>
              <p className="text-lg text-slate-500 leading-relaxed mb-8 max-w-lg">
                Commandez vos QR codes QRBags en quelques clics et recevez vos autocollants directement chez vous ou à votre agence. Chaque QR code est unique, personnalisé et prêt à être activé en 30 secondes.
              </p>
              ...
              <div className="relative">
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-slate-200/60 border border-slate-100 aspect-[3/4]">
                  <Image
                    ...
                    alt="Recevez votre QR code - QRBags"
                    fill
      ...
      <section className="py-20 lg:py-28 px-5 bg-white">
        <div className="max-w-6xl mx-auto">
          <FadeIn className="text-center mb-16">
            ...
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">Deux façons simples d&apos;obtenir vos autocollants QRBags</p>
          </FadeIn>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <FadeIn delay={0.2}>
              <div className="bg-violet-50/40 border border-violet-100/60 rounded-3xl p-9 h-full">
                ...
                <p className="text-[15px] text-slate-500 leading-relaxed mb-6">De nombreuses agences de voyage proposent directement les QR codes QRBags lors de la réservation de votre voyage. Demandez à votre agence si elle est partenaire QRBags.</p>
                <ul className="space-y-2.5">
