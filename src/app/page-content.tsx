      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="/#villes" className="text-[#e0e6f0] hover:text-[#ff2a6d] transition-colors">Villes</a>
        ...
        {isOpen && (
          <div className="md:hidden py-4 border-t border-[#1a2238]">
            <div className="flex flex-col gap-4">
              ...
              <a href="/#villes" className="text-[#e0e6f0] hover:text-[#ff2a6d]" onClick={() => setIsOpen(false)}>Villes couvertes</a>
...
// Hero Section - SEO optimized with Sénégal focus
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 mb-6">
              <span className="px-4 py-2 bg-[#ff2a6d]/20 border border-[#ff2a6d]/50 text-[#ff2a6d] text-sm rounded-full font-medium animate-pulse">
                La solution anti-bagage perdu au Sénégal
              </span>
            </div>

            {/* SEO-optimized H1 */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Protégez vos bagages au Sénégal avec QRBag
              <span className="block bg-gradient-to-r from-[#ff2a6d] to-[#d35400] bg-clip-text text-transparent text-3xl md:text-4xl lg:text-5xl mt-2">
                Étiquettes QR pour bagages perdus — Récupération en 24h
              </span>
            </h1>

            {/* Subtitle with SEO keywords */}
            <p className="text-[#a0a8b8] text-lg md:text-xl mb-8 max-w-xl mx-auto lg:mx-0">
              QRBag est la solution <strong className="text-white">anti-bagage perdu</strong> utilisée par plus de 500 voyageurs à <strong className="text-white">Dakar</strong> et au Sénégal. Un simple <strong className="text-white">scan QR code</strong> suffit pour retrouver votre valise, avec géolocalisation instantanée et notification WhatsApp.
            </p>
...
// Solutions Section - SEO optimized with H2 for each target
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#ff2a6d] to-[#d35400] bg-clip-text text-transparent mb-4">
            Solutions de protection de bagages au Sénégal
          </h2>
          <p className="text-[#a0a8b8] text-lg max-w-2xl mx-auto">
            Que vous soyez pèlerin Hajj ou voyageur au Sénégal, QRBag s&apos;adapte à vos besoins avec des solutions sur mesure pour éviter les bagages perdus.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {/* Hajj Card */}
          <article className="group bg-gradient-to-br from-[#1e3a2e] to-[#0d5e34] rounded-2xl p-6 border border-[#1e3a2e]/50 hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-[#1e3a2e]/30">
            <div className="text-5xl mb-4">🕋</div>
            <h2 className="text-xl font-bold text-white mb-3">Spécial Hajj &amp; Omra</h2>
            <p className="text-white/80 mb-6 text-sm leading-relaxed">
              Protection complète pour les <strong>pèlerins Hajj</strong> avec 3 bagages inclus (cabine + 2 soutes). Gérée par votre <strong>agence de voyage</strong> partenaire au Sénégal. Fini les valises perdues à Djeddah ou Médine.
            </p>
            <Link href="/hajj-omra">
          ...
          {/* Voyageur Card */}
          <article className="group bg-gradient-to-br from-[#d35400] to-[#e67e22] rounded-2xl p-6 border border-[#d35400]/50 hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-[#d35400]/30">
            <div className="text-5xl mb-4">✈️</div>
            <h2 className="text-xl font-bold text-white mb-3">Pour les voyageurs</h2>
            <p className="text-white/80 mb-6 text-sm leading-relaxed">
              Protection flexible pour <strong>tous vos voyages</strong> depuis le Sénégal. Choisissez 1 ou 3 bagages avec une durée adaptée à vos besoins. Parfait pour les vols internationaux depuis <strong>Dakar</strong>, Saint-Louis et Ziguinchor.
            </p>
          ...
          {/* Agences Card */}
          <article className="group bg-[#0a0f2c] rounded-2xl p-6 border border-[#1a2238] hover:scale-105 hover:border-[#ff2a6d]/30 transition-all duration-300 shadow-xl">
            <div className="text-5xl mb-4">🏢</div>
            <h2 className="text-xl font-bold text-white mb-3">Pour les agences de voyage</h2>
            <p className="text-[#a0a8b8] mb-6 text-sm leading-relaxed">
              Devenez <strong>partenaire QRBag</strong> et offrez la protection bagages à vos clients. Tableau de bord dédié, gestion des étiquettes QR, et suivi en temps réel. Rejoignez plus de <strong>500 agences</strong> au Sénégal.
            </p>
  ...
  const steps = [
    {
      ...
      icon: "📱",
      description: "Commandez vos étiquettes QR code via notre formulaire ou auprès de votre agence de voyage partenaire au Sénégal."
    },
    {
      number: "02",
      title: "Activez en 30s",
      icon: "⚡",
      description: "Scannez le QR code et remplissez le formulaire avec vos informations de voyage, téléphone et destination."
    },
    {
      number: "03",
      title: "Voyagez serein",
      icon: "✈️",
      description: "Collez l'autocollant QR sur vos bagages. Vos valises sont protégées du départ de Dakar à votre arrivée."
    },
    {
      number: "04",
      title: "Soyez notifié",
      icon: "🔔",
      description: "Si quelqu'un trouve votre bagage perdu, vous recevez une alerte instantanée via WhatsApp avec la géolocalisation."
    }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-[#a0a8b8] text-lg">
            Retrouvez votre <strong className="text-white">bagage perdu</strong> en 4 étapes simples
          </p>
        </div>
...
function TestimonialsSection() {
  const testimonials = [
    {
      name: "Mamadou Diallo",
      role: "Pèlerin Hajj 2025 - Dakar",
      content: "Grâce à QRBag, j'ai retrouvé ma valise perdue à l'aéroport de Djeddah en moins de 2 heures. Une invention géniale pour les pèlerins sénégalais !",
      avatar: "👴🏾"
    },
    {
      name: "Aminata Ndiaye",
      role: "Voyageuse fréquente - Dakar",
      content: "Simple, efficace et pas cher. J'utilise QRBag pour tous mes voyages depuis le Sénégal. Plus jamais de bagage perdu à l'AIBD !",
      avatar: "👩🏾"
    }
  ];
  ...
  return (
    <section id="tarifs" className="py-20 px-4 bg-[#080c1a]">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#ff2a6d] to-[#d35400] bg-clip-text text-transparent mb-4">
            Tarifs des étiquettes QR bagages
          </h2>
          <p className="text-[#a0a8b8] text-lg">
            Choisissez la formule adaptée à vos voyages depuis le Sénégal
          </p>
        </div>
...
// Section Villes couvertes au Sénégal - Contenu local SEO
function SenegalCoverageSection() {
  const cities = [
    { name: 'Dakar', desc: 'Aéroport international AIBD, gare maritime', icon: '🏙️' },
    { name: 'Thiès', desc: 'Gare ferroviaire, agences de voyage', icon: '🚂' },
    { name: 'Saint-Louis', desc: 'Aéroport, tourisme, agences Hajj', icon: '🏛️' },
    { name: 'Ziguinchor', desc: 'Aéroport Cap Skirring, Casamance', icon: '🌴' },
  ];

  const airports = [
    { name: 'AIBD - Aéroport International Blaise Diagne', location: 'Dakar' },
    { name: 'Aéroport de Saint-Louis', location: 'Saint-Louis' },
    { name: 'Cap Skirring', location: 'Ziguinchor' },
  ];

  return (
    <section id="villes" className="py-20 px-4 bg-[#0d1220]">
      <div className="max-w-6xl mx-auto">
        {/* Title */}
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#ff2a6d] to-[#d35400] bg-clip-text text-transparent mb-4">
            Nos services au Sénégal
          </h2>
          <p className="text-[#a0a8b8] text-lg max-w-2xl mx-auto">
            QRBag protège vos bagages à <strong className="text-white">Dakar</strong>, <strong className="text-white">Thiès</strong>,{' '}
            <strong className="text-white">Saint-Louis</strong>, <strong className="text-white">Ziguinchor</strong> et dans tous les{' '}
            aéroports du Sénégal (AIBD, Cap Skirring). Notre solution de géolocalisation par QR code fonctionne partout au Sénégal et à l&apos;international.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {cities.map((city, index) => (
            <div
              key={index}
              className="bg-[#0a0f2c] rounded-xl p-6 border border-[#1a2238] hover:border-[#ff2a6d]/30 transition-all hover:scale-105 text-center"
            >
              <div className="text-4xl mb-3">{city.icon}</div>
              <h3 className="text-lg font-bold text-white mb-2">{city.name}</h3>
              <p className="text-[#a0a8b8] text-sm">{city.desc}</p>
            </div>
          ))}
        </div>

        {/* Airports list */}
        <div className="bg-[#080c1a] rounded-xl p-6 border border-[#1a2238]">
          <div className="flex items-center gap-3 mb-4">
            <Plane className="w-6 h-6 text-[#ff2a6d]" />
            <h3 className="text-xl font-bold text-white">Aéroports couverts au Sénégal</h3>
          </div>
          <div className="grid sm:grid-cols-3 gap-4">
            {airports.map((airport, index) => (
              <div key={index} className="flex items-center gap-2 text-[#a0a8b8]">
                <MapPin className="w-4 h-4 text-[#d35400] flex-shrink-0" />
                <div>
                  <p className="text-sm font-medium text-white">{airport.name}</p>
                  <p className="text-xs">{airport.location}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="mt-8 grid sm:grid-cols-3 gap-4">
          <div className="flex items-center gap-3 bg-[#080c1a] rounded-lg p-4 border border-[#1a2238]">
            <Luggage className="w-8 h-8 text-[#ff2a6d]" />
            <div>
              <p className="text-white font-semibold text-sm">10 000+ bagages protégés</p>
              <p className="text-[#a0a8b8] text-xs">dans tout le Sénégal</p>
            </div>
          </div>
          <div className="flex items-center gap-3 bg-[#080c1a] rounded-lg p-4 border border-[#1a2238]">
            <Users className="w-8 h-8 text-[#ff2a6d]" />
            <div>
              <p className="text-white font-semibold text-sm">500+ agences partenaires</p>
              <p className="text-[#a0a8b8] text-xs">réparties au Sénégal</p>
            </div>
          </div>
          <div className="flex items-center gap-3 bg-[#080c1a] rounded-lg p-4 border border-[#1a2238]">
            <Shield className="w-8 h-8 text-[#ff2a6d]" />
            <div>
              <p className="text-white font-semibold text-sm">98% de récupération</p>
              <p className="text-[#a0a8b8] text-xs">en moins de 24 heures</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="py-20 px-4 bg-gradient-to-r from-[#d35400] to-[#ff2a6d]">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
          Ne laissez plus vos bagages se perdre au Sénégal
        </h2>
        <p className="text-white/90 max-w-2xl mx-auto mb-8 text-lg">
          Rejoignez les milliers de voyageurs et pèlerins qui protègent leurs bagages avec <strong>QRBag</strong>. Commandez vos étiquettes QR code en quelques clics et voyagez l&apos;esprit tranquille.
        </p>
    ...
    <section className="py-20 px-4 bg-[#0d1220]">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-[#a0a8b8] text-lg mb-8 max-w-2xl mx-auto">
          Notre équipe est disponible pour répondre à toutes vos questions et vous accompagner dans la protection de vos bagages au Sénégal.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/contact">
        ...
        <div className="grid md:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-[#a0a8b8] text-sm">
              Protection intelligente des bagages pour voyageurs et pèlerins au Sénégal.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#a0a8b8] text-sm">
              <li><Link href="/agence/connexion" className="hover:text-[#b8860b] transition-colors">Espace Agence</Link></li>
              <li><Link href="/admin/connexion" className="hover:text-[#ff2a6d] transition-colors">SuperAdmin</Link></li>
            </ul>
          </div>
        </div>
...
// Main Page Content - exported as named component
