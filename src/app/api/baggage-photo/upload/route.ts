...
// Même pattern que /api/checklist/upload-photo — fichier stocké hors public/, servi via /api/baggage-photo/[reference]
const UPLOAD_DIR = join(process.cwd(), 'uploads', 'baggage-photos');
...
export async function POST(request: NextRequest) {
  try {
    ...
    const relativePath = `uploads/baggage-photos/${filename}`;
