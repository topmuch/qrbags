        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 text-[#16234e]/75">
            ...
            <section>
              ...
              <p>
                Pour toute question relative aux présentes mentions légales, vous pouvez nous contacter à : <a href="mailto:contact@qrbag.com" className="text-[#e07c0a] hover:underline">contact@qrbag.com</a>
              </p>
            </section>
          </div>
